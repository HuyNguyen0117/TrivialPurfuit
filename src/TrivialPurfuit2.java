...
public class TrivialPurfuit2{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TrivialPurfuit2 window = new TrivialPurfuit2();
					window.frmTrivialPurfuit.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmTrivialPurfuit = new JFrame();
		frmTrivialPurfuit.setTitle("Trivial Purfuit");
		frmTrivialPurfuit.setBounds(100, 100, 1102, 845);
		frmTrivialPurfuit.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmTrivialPurfuit.getContentPane().setLayout(null);
		
		JButton btnNewButton_1 = new JButton("Trivial Purfuit");
		btnNewButton_1.setBounds(322, 334, 128, 128);
		frmTrivialPurfuit.getContentPane().add(btnNewButton_1);
		
		JButton btnWedge = new JButton("WEDGE");
		btnWedge.setBackground(Color.WHITE);
		btnWedge.setBounds(12, 24, 84, 84);
		frmTrivialPurfuit.getContentPane().add(btnWedge);
		...
		button_1.setBounds(151, 164, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_1);
		...
		button_2.setBounds(208, 220, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_2);
		...
		button_6.setBounds(264, 277, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_6);
		...
		button.setBounds(448, 459, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button);
		...
		button_3.setBounds(505, 516, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_3);
		...
		button_4.setBounds(562, 574, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_4);
		...
		button_5.setBounds(618, 630, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_5);
		
		JButton btnPlayer_2 = new JButton("WEDGE");
		btnPlayer_2.setBackground(Color.RED);
		btnPlayer_2.setBounds(674, 24, 84, 84);
		frmTrivialPurfuit.getContentPane().add(btnPlayer_2);
		...
		frmTrivialPurfuit.getContentPane().add(button_8);
		...
		frmTrivialPurfuit.getContentPane().add(button_9);
		...
		frmTrivialPurfuit.getContentPane().add(button_11);
		...
		frmTrivialPurfuit.getContentPane().add(button_12);
		...
		frmTrivialPurfuit.getContentPane().add(button_13);
		...
		frmTrivialPurfuit.getContentPane().add(btnPl);
		...
		frmTrivialPurfuit.getContentPane().add(button_15);
		...
		frmTrivialPurfuit.getContentPane().add(btnPlayer_1);
		...
		button_38.setBounds(448, 277, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_38);
		...
		button_39.setBounds(505, 220, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_39);
		...
		button_40.setBounds(562, 162, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_40);
		...
		button_41.setBounds(618, 104, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_41);
		...
		frmTrivialPurfuit.getContentPane().add(button_42);
		...
		frmTrivialPurfuit.getContentPane().add(button_43);
		...
		button_44.setBounds(264, 460, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_44);
		...
		button_45.setBounds(208, 518, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_45);
		...
		button_46.setBounds(152, 576, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_46);
		...
		button_47.setBounds(95, 632, 58, 58);
		frmTrivialPurfuit.getContentPane().add(button_47);
		...
		frmTrivialPurfuit.getContentPane().add(button_17);
		...
		frmTrivialPurfuit.getContentPane().add(button_18);
		...
		frmTrivialPurfuit.getContentPane().add(button_19);
		...
		frmTrivialPurfuit.getContentPane().add(button_21);
		...
		frmTrivialPurfuit.getContentPane().add(button_22);
		...
		frmTrivialPurfuit.getContentPane().add(button_23);
		...
		frmTrivialPurfuit.getContentPane().add(button_24);
		...
		frmTrivialPurfuit.getContentPane().add(button_25);
		...
		frmTrivialPurfuit.getContentPane().add(button_26);
		...
		frmTrivialPurfuit.getContentPane().add(button_27);
		...
		frmTrivialPurfuit.getContentPane().add(button_28);
		...
		frmTrivialPurfuit.getContentPane().add(button_29);
		...
		frmTrivialPurfuit.getContentPane().add(button_30);
		...
		frmTrivialPurfuit.getContentPane().add(button_31);
		...
		frmTrivialPurfuit.getContentPane().add(button_32);
		...
		frmTrivialPurfuit.getContentPane().add(button_33);
		...
		frmTrivialPurfuit.getContentPane().add(button_34);
		...
		frmTrivialPurfuit.getContentPane().add(button_35);
		...
		frmTrivialPurfuit.getContentPane().add(button_36);
		...
		frmTrivialPurfuit.getContentPane().add(button_37);
		...
		frmTrivialPurfuit.getContentPane().add(button_48);
		...
		frmTrivialPurfuit.getContentPane().add(button_49);
		...
		frmTrivialPurfuit.getContentPane().add(button_50);
		...
		frmTrivialPurfuit.getContentPane().add(button_51);
		...
		frmTrivialPurfuit.getContentPane().add(btnRa);
		...
		frmTrivialPurfuit.getContentPane().add(button_53);
		...
		frmTrivialPurfuit.getContentPane().add(button_54);
		...
		frmTrivialPurfuit.getContentPane().add(button_55);
		...
		frmTrivialPurfuit.getContentPane().add(btnPlayer);
